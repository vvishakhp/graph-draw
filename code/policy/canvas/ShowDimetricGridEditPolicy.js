/**
 * @class  .policy.canvas.ShowDimetricGridEditPolicy
 *
 ...
 *
 *     canvas.installEditPolicy(new  .policy.canvas.ShowDimetricGridEditPolicy());
 *     let shape =  new  .shape.basic.Text({text:"This is a simple text in a canvas with grid background."});
 *
...
import   from '../../packages'
 ...
 .policy.canvas.ShowDimetricGridEditPolicy =  .policy.canvas.DecorationPolicy.extend({

  NAME: " .policy.canvas.ShowDimetricGridEditPolicy",
