...
import   from '../../packages'
 ...
 .shape.pert.Activity =  .shape.layout.VerticalLayout.extend({

  NAME: " .shape.pert.Activity",
  ...
  init: function (attr, setter, getter) {
    ...
    //
    let bottom = new  .shape.layout.HorizontalLayout({stroke: 0})
