/**
 * @class  .ui.LabelEditor
 * Base class for all  .shape.basic.Label editors. The default implementation is to open
 ...
 *
 *     label.installEditor(new  .ui.LabelEditor({
...
import   from '../packages';
 ...
 .ui.LabelEditor = Class.extend({
    ...
    start: function( label)
    {
        ...
        if(newText){
            var cmd =new  .command.CommandAttr(label, {text:newText});
