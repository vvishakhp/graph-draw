...
export class Node extends Figure {
  ...
  private inputPorts: ArrayList<InputPort>;
  private outputPorts: ArrayList<OutputPort>;
  private hybridPorts: ArrayList<HybridPort>;

  private persistPorts: boolean;

  private portRelayoutRequired: boolean;

  private cachedPorts: ArrayList<Port>;
  ...
  constructor(attr, setter, getter) {
    ...
    this.hybridPorts = new ArrayList()
  ...
  public setPersistPorts(flag: boolean) {
  ...
  public getPersistPorts() {
    return this.getPersistPorts();
  }

  public toFront(figure) {
    super.toFront();
  }
